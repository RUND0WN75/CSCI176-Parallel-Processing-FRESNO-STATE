...
being displayed at the end. Array size is 350 million instead of 500 million due to my machine's inability to handle a
large array size, resulting in heap space errors.
...
public class Main {
    //Global vector (ArrayList) of size 350 million
