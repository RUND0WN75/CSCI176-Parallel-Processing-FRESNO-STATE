	...
	for (int i = 0; i < 3; i++) {
		...
		if (pid == 0) {
			...
			if (i == 0) {
				...
				cout << "Exec time for recursive version: " << setprecision(5) << exec_time1 << " milliseconds" << endl;
				cout << "Exec time for iterative version: " << setprecision(5) << exec_time2 << " milliseconds" << endl;
			...
			//Child 2
				...
				cout << "Recursive fibonacci: " << x << endl;
			...
			//Child 3
				...
				cout << "Iterative fibonacci: " << y << endl;
